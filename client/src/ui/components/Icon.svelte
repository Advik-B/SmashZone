<script lang="ts">
  // One place for every inline SVG the UI uses. `stroke`/`fill` icons both use
  // currentColor so callers set color via CSS; crown/trophy keep their gold tint.
  type IconName =
...
>
  ...
  {:else if name === "crown"}
    <path fill="#ffd76e" stroke="#8a6416" stroke-width="1.5" d="M11.562 3.266a.5.5 0 0 1 .876 0L15.39 8.87a1 1 0 0 0 1.516.294L21.183 5.5a.5.5 0 0 1 .798.519l-2.834 10.246a1 1 0 0 1-.956.734H5.81a1 1 0 0 1-.957-.734L2.02 6.02a.5.5 0 0 1 .798-.519l4.276 3.664a1 1 0 0 0 1.516-.294z" />
  {:else if name === "bot"}
  ...
  {:else if name === "play"}
    <path fill="currentColor" stroke-width="1" d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z" />
  {:else if name === "pause"}
    <rect fill="currentColor" stroke-width="1" x="14" y="3" width="5" height="18" rx="1" /><rect fill="currentColor" stroke-width="1" x="5" y="3" width="5" height="18" rx="1" />
  {:else if name === "koPrev"}
    <path fill="currentColor" stroke-width="1" d="M17.971 4.285A2 2 0 0 1 21 6v12a2 2 0 0 1-3.029 1.715l-9.997-5.998a2 2 0 0 1-.003-3.432z" /><path d="M3 20V4" />
  {:else if name === "koNext"}
    <path d="M21 4v16" /><path fill="currentColor" stroke-width="1" d="M6.029 4.285A2 2 0 0 0 3 6v12a2 2 0 0 0 3.029 1.715l9.997-5.998a2 2 0 0 0 .003-3.432z" />
